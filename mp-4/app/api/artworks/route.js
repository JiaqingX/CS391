export async function GET(request) {
  ...
  const query = searchParams.get("q") || "madonna"; 

  const url = `https://api.harvardartmuseums.org/object?apikey=${apiKey}&size=15&hasimage=1&title=${encodeURIComponent(query)}`;
